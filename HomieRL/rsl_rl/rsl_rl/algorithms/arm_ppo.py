...
from rsl_rl.modules.arm_ac import ArmActorCritic
from rsl_rl.storage import ArmRolloutStorage
...
class ArmPPO:
    ...
    def __init__(self, actor_critic,
        ...
        if self.actor_critic.decoder:
            self.decoder_optimizer = optim.Adam(self.actor_critic.parameters(),
                                                lr=PPO_Args.adaptation_module_learning_rate)
        self.transition = ArmRolloutStorage.Transition()
    ...
    def init_storage(self,
                     ...
                     action_shape,
                     action_woc_shape):
        self.storage = ArmRolloutStorage(num_envs, num_transitions_per_env, actor_obs_shape, privileged_obs_shape,
