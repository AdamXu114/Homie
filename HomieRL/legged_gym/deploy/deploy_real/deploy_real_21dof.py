...
class Controller:
    def __init__(self, config: Config) -> None:
        ...
        model = onnx.load("/workspaces/humanoid_g1/deploy/pre_train/g1/policy_1_21dof_normal_new5.onnx")#policy_1_21dof_test.onnx"
        onnx.checker.check_model(model)
        self.policy = ort.InferenceSession("/workspaces/humanoid_g1/deploy/pre_train/g1/policy_1_21dof_normal_new5.onnx")
